...
const InternNavbar = ({ notifications = [] }) => {
    ...
    <nav className="bg-black text-white shadow-lg relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/messages" className="text-gray-300 hover:text-white transition-colors duration-200 font-medium tracking-wide">
              MESSAGES
            </Link>
            <Link href="/profile" className="text-gray-300 hover:text-white transition-colors duration-200 font-medium tracking-wide">
              PROFILE
            </Link>
          </div>
      ...
      <div className="md:hidden bg-gray-900 border-t border-gray-800">
        <div className="px-2 pt-2 pb-3 space-y-1">
          <Link href="/messages" className="block px-3 py-2 text-gray-300 hover:text-white font-medium tracking-wide">
            MESSAGES
          </Link>
          <Link href="/profile" className="block px-3 py-2 text-gray-300 hover:text-white font-medium tracking-wide">
            PROFILE
          </Link>
        </div>
      </div>
